...
function plot_P11(N, R_oi, tspan, t, C, Omega, nu)
    f2 = figure; 
    ...
    hold on; 
    for i = 1:4  
        P11 = calc_P11(N, R_oi, u(y(i,:)), y(i,:), Omega, nu);
        plot(R, P11, 'DisplayName', strcat('t = ', num2str(times(i))),'LineWidth', 1.25, 'LineStyle', lines(i), 'Color', 'black');
    end

    % Plot settings
    xlim([1 R_oi])
    title('Numerical solutions of $P_{11}$', 'Fontsize', 18, 'Interpreter','latex');
    xlabel('$R$', 'Interpreter','latex','Fontsize', 18);
    ylh = ylabel('$P_{11}$', 'Interpreter','latex', 'rotation', 0,'Fontsize', 18);
    ...
    print('-depsc2','-painters','/Users/james/Desktop/MS6003-Thesis/model3/figures/eps_figs/P11.eps'); 
end 